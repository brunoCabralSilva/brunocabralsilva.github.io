...
class Footer extends React.Component {
  render() {
    return (
      <footer className="z-40 flex flex-col items-center w-full text-black relative">
        <img src={require('../images/h4.png')} alt="" className="w-full h-full object-cover object-bottom opacity-70 absolute" />
